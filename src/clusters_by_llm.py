...
def cluster_chain():
    ...
    prompt = ChatPromptTemplate.from_messages(
            [
                (
                    "system",
                    '''you are given a list of documents with their content and IDs. Please classify each document into one of the following categories: ["politics", "governance", "sports", "international relations", "business", "health", "science and technology", "culture", "security", "weather", "fashion", "energy", "entertainment", "others"]
